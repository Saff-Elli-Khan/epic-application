...
beforeAll(async () => {
    ...
    global.database = await new epic_odm_1.DatabaseSession(exports_1.DatabaseAdapter).start();
    global.supertest = (0, supertest_1.agent)(exports_1.HTTPServer.Application.Framework);
});
afterAll(async () => {
