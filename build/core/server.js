  ...
  constructor() {
    ...
    this._onRouteError = (err, req, res) => {
      ...
      if (res.statusCode === http_status_1.OK)
        ...
        else res.status(http_status_1.INTERNAL_SERVER_ERROR);
      ...
      if (res.statusCode >= http_status_1.INTERNAL_SERVER_ERROR) {
        ...
        return new epic_express_1.CreateResponse(
      ...
      return new epic_express_1.CreateResponse(
        err instanceof epic_express_1.RouteAccessDenied
          ? req.translator.tr(
              `You are not permitted! Missing permission '<>'.`,
              {
                params: [err.Permission],
              }
            )
          : (err === null || err === void 0 ? void 0 : err.issues) ||
            (err === null || err === void 0 ? void 0 : err.message) ||
            err ||
