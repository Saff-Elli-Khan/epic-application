...
exports.AppMiddlewares = exports.UtilityMiddlewares = void 0;
...
const UtilityMiddlewares = async (Framework) => Framework
    // Utility Middlewares
    .use([
...
exports.UtilityMiddlewares = UtilityMiddlewares;
const AppMiddlewares = async (Framework) => Framework.use([
